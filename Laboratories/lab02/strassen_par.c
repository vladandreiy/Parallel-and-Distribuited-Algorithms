...
int main(int argc, char *argv[]) {
	...
	pthread_create(&threads[2], NULL, f3, NULL);
	pthread_create(&threads[3], NULL, f4, NULL);
	pthread_create(&threads[4], NULL, f5, NULL);
	pthread_create(&threads[5], NULL, f6, NULL);
	pthread_create(&threads[6], NULL, f7, NULL);
